...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:butlrapp_server/src/generated/chat_session.spider.dart' as _i5;
import 'package:butlrapp_server/src/generated/chat_response.spider.dart' as _i6;
import 'package:butlrapp_server/src/generated/chat_message.spider.dart' as _i7;
import 'package:butlrapp_server/src/generated/task.spider.dart' as _i8;
import 'package:butlrapp_server/src/generated/greetings/greeting.dart' as _i9;
import 'package:butlrapp_server/src/generated/protocol.dart';
import 'package:butlrapp_server/src/generated/endpoints.dart';
...
class _ChatEndpoint {
  ...
  _i3.Future<_i5.ChatSession> createSession(
    _i1.TestSessionBuilder sessionBuilder,
    String title,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<List<_i5.ChatSession>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
      ...
      try {
        ...
        var _localReturnValue =
            await (_localCallContext.method.call(
                ...
                as _i3.Future<_i6.ChatResponse>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _TaskEndpoint {
  ...
  _i3.Future<List<_i8.Task>> getTasksByDate(
    _i1.TestSessionBuilder sessionBuilder,
    DateTime date,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i8.Task>> getIncompleteTasks(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'task',
            method: 'getIncompleteTasks',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'task',
          methodName: 'getIncompleteTasks',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<_i8.Task?> completeTask(
    _i1.TestSessionBuilder sessionBuilder,
    int taskId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<bool> clearAll(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'task',
