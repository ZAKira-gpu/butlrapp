...
class TaskUpdateTable extends _i1.UpdateTable<TaskTable> {
  ...
  _i1.ColumnValue<String, String> recurrence(String? value) => _i1.ColumnValue(
    table.recurrence,
    value,
  );

  _i1.ColumnValue<int, int> recurrenceInterval(int? value) => _i1.ColumnValue(
...
class TaskTable extends _i1.Table<int?> {
  TaskTable({super.tableRelation}) : super(tableName: 'task') {
    ...
    recurrence = _i1.ColumnString(
      'recurrence',
      this,
    );
    recurrenceInterval = _i1.ColumnInt(
      'recurrenceInterval',
      this,
    );
  ...
  late final _i1.ColumnString recurrence;

  late final _i1.ColumnInt recurrenceInterval;
